    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="nav-left-sidebar sidebar-dark">
            ...
            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="reviews_admin"  aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-fw  fas fa-thumbs-up"></i>Reviews</a>
                            ...
                            <div class="card">
                                <div class="card-header">
                                  <!--  <h5 class="mb-0">Transactions</h5>-->
                                    <p>This data table displays the reviews made by various clients</p>
                                </div>
                                <div class="card-body">
