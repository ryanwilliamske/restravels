...
<br> <br> 
  ...
  <!-- ============================================================== -->
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Add a New service</h5>
                                <div class="card-body">
                                <form action="submit" method="POST">
                                            @csrf
                                        <div class="form-group">
                                         
                                            <input name="service_name" type="text" name="name" data-parsley-trigger="change" required="" placeholder="Enter user name" autocomplete="off" class="form-control">
                                        </div>
                                        <!-- <div class="form-group">
                                            
                                            <input id="service_img" type="email" name="Enter email" data-parsley-trigger="change" required="" placeholder="Upload Image" autocomplete="off" class="form-control">
                                        </div> -->
                                        <div class="form-group">
                                           
                                            <input  name="service_descript" type="text" placeholder=" Add Desccription" required="" class="form-control">
                                        </div>
                                        <div class="form-group">
                                           
                                            <input name="service_price"  type="text" required="" placeholder="Price" class="form-control">
                                        </div>
                                        <div class="form-group">
                                          
                                            <input name="service_type" type="text" required="" placeholder="Type" class="form-control">
                                        </div>
                                     ...
                                     <!--   <div class="form-group">
                                        ...
                                        <option class="form-control"  value="vehicle">Vehicle Hire</option>
                                        <option class="form-control"  value="travel">Travel</option>
                                        <option class="form-control"  value="adventure">Adeventure/ Tours</option>
