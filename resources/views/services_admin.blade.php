...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="nav-left-sidebar sidebar-dark">
            ...
            <li class="nav-item">
                                <a class="nav-link active" href="services_admin"  aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-fw  fas fa-gem"></i>Services</a>
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <!-- ============================================================== -->
                    <div class="row">
                         <!--Leads to form for adding new service-->
                    <div class="card-body border-top">
                                           
                                           <a href="services_form" class="btn btn-primary btn-lg">Add a new service</a>
                            ...
                            <div class="card">
                                <div class="card-header">
                                  <!--  <h5 class="mb-0">Transactions</h5>-->
                                    <p>Services offered to the clients</p>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                            <thead>
                                                <!--Insert table data here for transactions from the database
                                                -->
                                                <tr>
                                                    <th>Name</th>
                                                    <th>Type</th>
                                             ...
                                             <?php
                                             use App\Services;
                                            $servicestuff = Services::all();
                                            ?>

                                            @foreach($servicestuff as $row)
                                            <tbody>
                                            <tr>

                                                <td>{{$row['service_name']}}</td>
                                                 <td>{{$row['service_type']}}</td>
                                                <td>{{$row['service_descript']}}</td>
                                                <td>{{$row['service_price']}}</td>
                                                <td>
                                                    
                                                    <form action="{{ route('services_admin.delete', $row['id']) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
